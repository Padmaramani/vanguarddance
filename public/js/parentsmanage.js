...
$('#addParentModal').on('hidden.bs.modal', function () {
    ...
    function initializeRows(parents) {
        ...
        $table = $('<table class="table table-bordered table-inverse">');
         // caption
    $table.append('<caption><h3><b>Parent Database</b></h3></caption>')
      .append('<thead>').children('thead') 
      .append('<tr />').children('tr')
      .append('<th>Parent Name</th><th>Parent Email</th><th>Parent Phone</th><th>Dancer Name</th><th>Update button</th><th>Remove Button</th><th>ID<th>');
...
//        var parentsToAdd = [];
        for (var i = 0; i < parents.length; i++) {
            ...
            .append("<td>"+parents[i].Parents[j].id+"</td>");
        }
    }
